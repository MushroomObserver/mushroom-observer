...
#
#  = Integration Controller Test Helpers (mostly from Controller Test Helpers)
#
...
module IntegrationControllerExtensions
  ##############################################################################
  #
  ...
  # # NOTE: Next two added from integration_extensions
