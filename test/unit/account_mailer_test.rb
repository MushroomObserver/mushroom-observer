...
################################################################################
  ...
  def test_email_1
    ...
    run_mail_test('admin_request', rolf) do
      AccountMailer.admin_request(katrina, rolf, project,
  ...
  def test_email_3
    ...
    run_mail_test('comment_response', rolf) do
      email = AccountMailer.comment(dick, rolf, obs, comment)
    end
  end
  ...
  def test_email_4
    ...
    run_mail_test('comment', mary) do
      email = AccountMailer.comment(rolf, mary, obs, comment)
    end
  end
  ...
  def test_email_5
    ...
    run_mail_test('commercial_inquiry', image.user) do
      AccountMailer.commercial_inquiry(mary, image,
  ...
  def test_email_6
    ...
    run_mail_test('consensus_change', mary) do
      AccountMailer.consensus_change(dick, mary, obs, name1, name2,
                                            obs.created_at)
    end
  end
  ...
  def test_email_7
    run_mail_test('denied') do
      AccountMailer.denied(junk)
    end
  end

  def test_email_8
    run_mail_test('email_features', rolf) do
      AccountMailer.email_features(rolf, 'A feature')
    end
  end
  ...
  def test_email_9
    ...
    run_mail_test('location_change', mary) do
      AccountMailer.location_change(dick, mary, loc.updated_at, loc,
                                           desc, 1, 2, 1, 2)
    end
  end
  ...
  def test_email_10
    ...
    run_mail_test('name_change', mary) do
      AccountMailer.name_change(dick, mary, name.updated_at, name, desc,
  ...
  def test_email_12
    ...
    run_mail_test('name_proposal', rolf) do
      AccountMailer.name_proposal(mary, rolf, naming, obs)
    end
  end
  ...
  def test_email_13
    ...
    run_mail_test('naming_for_observer', rolf) do
      AccountMailer.naming_for_observer(rolf, naming, notification)
    end
  end
  ...
  def test_email_14
    ...
    run_mail_test('naming_for_tracker', mary) do
      AccountMailer.naming_for_tracker(mary, naming)
    end
  end

  def test_email_15
    run_mail_test('new_password', rolf) do
      AccountMailer.new_password(rolf, 'A password')
    end
  end
  ...
  def test_email_16
    ...
    run_mail_test('observation_change', mary) do
      AccountMailer.observation_change(dick, mary, obs,
    ...
    run_mail_test('observation_destroy', mary) do
      AccountMailer.observation_change(dick, mary, nil,
  ...
  def test_email_17
    ...
    run_mail_test('observation_question', obs.user) do
      AccountMailer.observation_question(rolf, obs,
  ...
  def test_email_18
    ...
    run_mail_test('publish_name', rolf) do
      AccountMailer.publish_name(mary, rolf, name)
    end
  end

  def test_email_19
    run_mail_test('user_question', mary) do
      AccountMailer.user_question(rolf, mary,
  ...
  def test_email_20
    run_mail_test('verify', mary) do
      AccountMailer.verify(mary)
    end
  end

  def test_email_21
    run_mail_test('webmaster_question') do
      AccountMailer.webmaster_question(mary.email, 'A question')
    end
  end

  def test_email_22
    run_mail_test('email_registration') do
      AccountMailer.email_registration(nil, conference_registrations(:njw_at_msa))
    end
  end
  ...
  def test_email_23
    run_mail_test('update_registration') do
      ...
      reg.save
      AccountMailer.update_registration(nil, reg, before)
    end
  end

  def test_email_24
    run_mail_test('verify_api_key', rolf) do
      AccountMailer.verify_api_key(rolf, dick, ApiKey.first)
    end
  end
  ...
  def test_email_add_specimen_not_curator
    ...
    run_mail_test('add_specimen_not_curator', rolf) do
      AccountMailer.add_specimen_not_curator(mary, rolf, specimen)
    end
  end
end
