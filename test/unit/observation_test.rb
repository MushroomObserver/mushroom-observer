...
################################################################################
  ...
  def test_email_notification_1
    ...
    observations(:coprinus_comatus_obs).calc_consensus(@rolf)
    observations(:coprinus_comatus_obs).reload
    ...
    observations(:coprinus_comatus_obs).calc_consensus(@dick)
    observations(:coprinus_comatus_obs).reload
    assert_equal(names(:peltigera), observations(:coprinus_comatus_obs).name)
    assert_equal(0, QueuedEmail.all.length)
  end
  ...
  def test_email_notification_2
    ...
    @rolf.email_observations_naming = true
    @rolf.save
    observations(:coprinus_comatus_obs).user.reload
    new_naming = Naming.create(
      :created     => Time.now,
      :modified    => Time.now,
      :observation => observations(:coprinus_comatus_obs),
    ...
    votes(:coprinus_comatus_other_naming_rolf_vote).value = 3
    votes(:coprinus_comatus_other_naming_rolf_vote).save
    observations(:coprinus_comatus_obs).calc_consensus(@mary)
  ...
  def test_email_notification_3
    ...
    observations(:coprinus_comatus_obs).where = 'Somewhere else'
    observations(:coprinus_comatus_obs).save
    assert_equal(4, QueuedEmail.all.length)

    # Same deal with adding and removing images.
    observations(:coprinus_comatus_obs).add_image_by_id(images(:disconnected_coprinus_comatus_image).id)
    assert_equal(4, QueuedEmail.all.length)
    observations(:coprinus_comatus_obs).remove_image_by_id(images(:disconnected_coprinus_comatus_image).id)
    assert_equal(4, QueuedEmail.all.length)
    assert_email(3,
  ...
  def test_email_notification_4
    ...
    User.current = @rolf
    observations(:coprinus_comatus_obs).reload
    observations(:coprinus_comatus_obs).destroy
