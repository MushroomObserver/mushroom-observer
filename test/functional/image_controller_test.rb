...
################################################################################
  ...
  def test_next_image_ss
    ...
    assert_response(:action => "show_image", :id => next_id)
  end

  # Test next_image in the context of a search
  def test_next_image_search
    search_state = SearchState.lookup({}, :images)
    search_state.setup('Title', @controller.field_search(["names.search_name",
      "images.notes", "images.copyright_holder"], "%Notes%"),
    ...
    assert_response(:action => "show_image", :id => next_id, :seq_key => state.id)
  end
  ...
  def test_prev_image_ss
    ...
    assert_response(:action => "show_image", :id => prev_id)
  end
