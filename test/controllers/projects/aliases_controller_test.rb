...
module Projects
  class AliasesControllerTest < FunctionalTestCase
    ...
    def test_show_returns_json_when_requested
      get(:show, params: { project_id: @project.id, id: @project_alias.id },
                 format: :json)
      assert_response(:success)
      assert_equal("application/json; charset=utf-8", response.content_type)
    ...
    def test_create_returns_error_json_with_invalid_params
      post(:create, params: {
             project_id: @project.id,
             project_alias: { name: "" }  # Invalid params
           }, format: :json)
    ...
    def test_update_returns_json_when_requested
      patch(:update, params: {
              project_id: @project.id,
              id: @project_alias.id,
              project_alias: { name: "Updated Name" }
    ...
    def test_update_returns_error_json_with_invalid_params
      patch(:update, params: {
              project_id: @project.id,
              id: @project_alias.id,
              project_alias: { name: "" }  # Invalid params
    ...
    def test_destroy_returns_no_content_when_json_requested
