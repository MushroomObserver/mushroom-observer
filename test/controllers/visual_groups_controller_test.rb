...
class VisualGroupsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create visual_group" do
    assert_difference('VisualGroup.count') do
      post visual_groups_url, params: { visual_group: { name_id: @visual_group.name_id, reviewed: @visual_group.reviewed } }
    end
  ...
  test "should update visual_group" do
    patch visual_group_url(@visual_group), params: { visual_group: { name_id: @visual_group.name_id, reviewed: @visual_group.reviewed } }
