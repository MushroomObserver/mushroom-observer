...
class BoundsHiddenFieldsTest < ComponentTestCase
  def test_renders_all_six_bound_fields
    html = render_component(Components::Form::BoundsHiddenFields.new)
  ...
  def test_renders_with_custom_target_controller
    html = render_component(
      Components::Form::BoundsHiddenFields.new(target_controller: :map)
    )
  ...
  def test_renders_with_location_values
    ...
    html = render_component(
      Components::Form::BoundsHiddenFields.new(location: location)
    )
