...
class LinkIconTest < ComponentTestCase
  ...
  def test_title_adds_tooltip_and_sr_only_label
    ...
    assert_html(html,
                ...
                "[title='#{:edit.ti}'][data-trigger='tooltip']")
  ...
  def test_caller_data_attrs_merge_with_tooltip_data
    ...
    # Tooltip trigger still present alongside caller's custom data attr.
    assert_html(html, "span[data-trigger='tooltip'][data-other='v']")
  end
