...
class Components::ExportStatusControlsTest < ComponentTestCase
  ...
  def test_no_render_for_non_reviewer
    ...
    html = render(Components::ExportStatusControls.new(object: names(:fungi)))
  ...
  def test_ok_for_export_true_bolds_current_state
    ...
    html = render(Components::ExportStatusControls.new(object: name))
  ...
  def test_diagnostic_flag_for_image
    ...
    html = render(
      Components::ExportStatusControls.new(object: image, flag: :diagnostic)
    )
