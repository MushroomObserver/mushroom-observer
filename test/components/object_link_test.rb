...
class ObjectLinkTest < ComponentTestCase
  def test_renders_anchor_to_object_show_page
    ...
    html = render(Components::ObjectLink.new(object: project))
  ...
  def test_name_override_replaces_default_label
    project = projects(:bolete_project)
    html = render(Components::ObjectLink.new(object: project, name: "BP"))
  ...
  def test_nil_object_renders_nothing
    ...
    assert_equal("", render(Components::ObjectLink.new(object: nil)))
  end
end
