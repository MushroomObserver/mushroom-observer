...
class NameParseTest < UnitTestCase
  ...
  def test_genus_synonym_agaricus
    ...
    assert_equal([names(:psalliota)], name_parse.find_synonym_names(rolf))
  end
