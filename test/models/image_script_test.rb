...
class ScriptTest < UnitTestCase
  ...
  # The stable autogenerated ID of :in_situ_image
  # We cannot reference the db for the reason stated in
  # test_retransfer_image below
  def in_situ_id
    688136226
  end
  ...
  test "process_image" do
    ...
    assert_equal(in_situ_id, img.id, "in_situ_id defined incorrectly")
