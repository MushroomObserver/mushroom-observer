...
module Views::Controllers::Translations
  class FormTest < ComponentTestCase
    ...
    def test_renders_language_header
      assert_html(html, "h4.font-weight-bold", text: "#{@lang.name}:")
    end
    ...
    def test_save_button_has_stimulus_target
      assert_html(html, "button[data-translation-target='saveButton']")
    end
    ...
    def test_cancel_button_has_stimulus_target
      assert_html(html, "button[data-translation-target='cancelButton']")
    end
    ...
    def test_reload_link_has_turbo_stream
      assert_html(html, "a#reload_button[data-turbo-stream='true']")
    end
    ...
    def test_locale_select_has_stimulus_target
      assert_html(html, "select[data-translation-target='localeSelect']")
    end

    def test_locale_select_has_stimulus_action
      assert_html(html, "select[data-action='translation#changeLocale']")
    end

    def test_locale_select_has_selected_option
      assert_html(html, "option[value='#{@lang.locale}'][selected]")
    end
    ...
    def test_non_official_lang_renders_official_section
      ...
      assert_html(non_official_html, "#translation_official")
      assert_html(non_official_html,
    ...
    def test_non_official_lang_shows_official_text
      ...
      assert_html(non_official_html, "#translation_official p")
    end
    ...
    def test_single_tag_renders_one_textarea
      ...
      assert_html(single_html, "textarea[name='tag_one']", count: 1)
    end

    def test_single_tag_has_no_between_notes
      single_html = render_single_tag_form

      assert_not_includes(single_html, :edit_translations_plural.t)
      assert_not_includes(single_html, :edit_translations_singular.t)
    end
