...
module Views::Controllers::Account::Profile
  class FormTest < ComponentTestCase
    ...
    # User without a profile image: upload section uses "Upload
    # photo:" label and all upload fields submit under user[upload][].
    ...
    # photo:" label and copyright fields are pre-filled from the
    # existing image.
