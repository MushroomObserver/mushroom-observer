class CreateUserStats < ActiveRecord::Migration[7.1]
  def up
    create_table :user_stats do |t|
      ...
      t.integer(:locations_versions, default: 0, null: false)
      ...
      t.integer(:names_versions, default: 0, null: false)
      ...
      t.integer(:translation_strings_versions, default: 0, null: false)
