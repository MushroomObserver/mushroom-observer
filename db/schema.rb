...
ActiveRecord::Schema[7.2].define(version: 20_260_619_233_247) do
  ...
  create_table "external_links", id: :integer, charset: "utf8mb3",
    ...
    t.virtual("import_target", type: :string,
                               as: "(case when (`relationship` = 1) then concat(`target_type`,_utf8mb4':',`target_id`) end)", stored: true)
  ...
  create_table "inat_import_job_trackers", charset: "utf8mb4",
                                           collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "observations", id: { type: :integer, unsigned: true },
    ...
    t.index(%w[source_id external_id],
            name: "index_observations_on_source_id_and_external_id", unique: true)
  end
  ...
  create_table "sources", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                          force: :cascade do |t|
