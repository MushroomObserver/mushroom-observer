...
# missing element means use default
# controller: {      # hash of controller attributes
#   index: true|false,  # Does controller have index action; default: false
#   actions {           # hash of actions for this cotroller
