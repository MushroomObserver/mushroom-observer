...
#
# DEFERRED: flipping this invalidates every existing encrypted cookie/message
# with no rotator in front of it -- needs a dedicated PR to build and run the
# rotator before this can be set.
