...
- Consolidate validation-error display into `Components::Form::Errors` ([PR4901](https://github.com/MushroomObserver/mushroom-observer/pull/4901), phase 1) ([PR4914](https://github.com/MushroomObserver/mushroom-observer/pull/4914), @nimmolo)
