...
#
# @example
#   render(Components::ActiveLink.new("Latest", observations_path))
#   render(Components::ActiveLink.new(nil, observations_path) { "Latest" })
class Components::ActiveLink < Components::Base
