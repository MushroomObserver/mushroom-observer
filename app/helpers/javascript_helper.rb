...
#
#  *NOTE*: Don't use +javascript_include_tag+ anymore, since it is unsafe.
#  Note, this set of helpers cannot handle the old <tt>javascript_include_tag
#  :defaults</tt> functionality yet. 
#
#  == Usage
#
#    # In view:
...
#    <%= sort_javascript_includes.map(&:javascript_include_tag) %>
#
#  == Methods
#
#  javascript_include::       Include javascript lib in header.
#  sort_javascript_includes:: Get javascript libs already included (in correct order of dependency).
#  focus_on::                 Focuses on a form field -- MUST GO INSIDE FORM!
#
##############################################################################

module ApplicationHelper::Javascript
