...
module InterestIconsHelper
  def draw_interest_icons(object)
    ...
    def interest_icon_big(type, alt) # :nodoc:
      image_tag("#{type}2.png", alt: alt, width: "50px", height: "50px",
                                class: "interest_big", title: alt)
    end

    # Create small icon image.
    def interest_icon_small(type, alt) # :nodoc:
      image_tag("#{type}3.png", alt: alt, width: "23px", height: "23px",
                                class: "interest_small", title: alt)
    end
