...
class Image < AbstractModel # rubocop:disable Metrics/ClassLength
  ...
  def log_update
    (glossary_terms + observations).each do |object|
      object.log(:log_image_updated, user: user, name: log_name, touch: false)
    end
  end
