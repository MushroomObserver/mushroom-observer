...
class Views::Controllers::TestPages::IconLibraryComparison::Show <
  ...
  ICON_ROWS = [
    ...
    [:ban, "ban-fill", "ban"],
    [:plus, "plus-lg", "circle-plus"],
    [:minus, "dash-lg", "circle-minus"],
