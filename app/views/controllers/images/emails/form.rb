...
# Form for sending a commercial inquiry email about an image.
# Rendered by `Images::EmailsController#new` (HTML mode and the
# ModalTurboForm-wrapped turbo_stream mode). Creates its own
