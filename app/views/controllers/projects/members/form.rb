...
# Form for adding or editing project members. Rendered by
# `Projects::MembersController#{index,new,edit}`.
#
# For new members: renders an autocompleter to select a user.
