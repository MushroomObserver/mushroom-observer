...
# Phlex form component for downloading observations in various
# formats. Rendered by `Observations::DownloadsController#new`, and
# also by `SpeciesLists::DownloadsController#new` (which references
# this view by its full namespace — downloading the obs in a
# species list reuses the same UI).
#
# @example
