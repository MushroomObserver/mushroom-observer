...
# Form for creating or editing observations. Includes image upload,
# location autocomplete, naming (on create), specimen fields, notes,
# projects, and species lists. Rendered by
# `ObservationsController#{new,edit}`.
#
# @example Usage
...
module Views::Controllers::Observations
  class Form < ::Components::ApplicationForm
    ...
    def view_template
      title_bar_submit(button_name, disable_with: :submitting.ti)
    ...
    def form_data_attributes
      {
        ...
        map_autocompleter__location_outlet:
    ...
    # --- Notes Panel: see Form::NotesPanel mixin ---
