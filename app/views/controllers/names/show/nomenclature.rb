...
#
# Originally `_nomenclature.html.erb` (~146 lines) — also rendered
# from `show_past_name` and `add_comment (via _object)`. Those
# callers will need updating to render this Phlex view directly.
