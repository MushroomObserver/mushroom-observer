...
xml.tag!(
  ...
  if !detail
    ...
    if object.namings.any?
      xml.namings(number: object.namings.size) do
    ...
    if object.votes.any?
      xml.votes(number: object.votes.size) do
    ...
    if object.images.size > 1
      xml.images(number: object.images.size - 1) do
        object.images.each do |image|
    ...
    if object.collection_numbers.any?
      xml.collection_numbers(number: object.collection_numbers.size) do
    ...
    if object.herbarium_records.any?
      xml.herbarium_records(number: object.herbarium_records.size) do
    ...
    if object.sequences.any?
      xml.sequences(number: object.sequences.size) do
    ...
    if object.external_links.any?
      xml.external_links(number: object.external_links.size) do
