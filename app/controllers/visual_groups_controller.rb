class VisualGroupsController < ApplicationController
  before_action :login_required # :set_visual_group, only: %i[ show edit update destroy ]

  # GET /visual_groups or /visual_groups.json
  def index
    @visual_groups = VisualGroup.where('group_name_id IS NOT NULL')
  end
...
#         format.html { redirect_to visual_group_url(@visual_group), notice: "Visual group was successfully created." }
#         format.json { render :show, status: :created, location: @visual_group }
#       else
#         format.html { render :new, status: :unprocessable_entity }
#         format.json { render json: @visual_group.errors, status: :unprocessable_entity }
#       end
#     end
#   end
...
#         format.html { redirect_to visual_group_url(@visual_group), notice: "Visual group was successfully updated." }
...
#     respond_to do |format|
#       format.html { redirect_to visual_groups_url, notice: "Visual group was successfully destroyed." }
