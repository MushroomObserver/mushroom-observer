...
class ImagesController < ApplicationController
  ...
  alias_method :list_images, :index
  ...
  #   namings/create, and namings/edit (via _show_images partial)
  ...
  def reuse_image_for_glossary_term
    ...
    if image
      redirect_to images_reuse_image_path(@object)
  ...
  # Linked from: observer/show_observation and account/edit (profile)
  # Inputs:
