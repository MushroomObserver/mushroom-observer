module PatternSearch
  ...
  class BadYesNoBothError < Error
    def to_s
      :pattern_search_bad_yes_no_both_error.t(term: args[:var].inspect, value: args[:val].inspect)
    end
  end
  ...
  class BadHerbariumError < Error
    def to_s
      :pattern_search_bad_herbarium_error.t(term: args[:var].inspect, value: args[:val].inspect)
    end
  end
  ...
  class BadRankRangeError < Error
    def to_s
      :pattern_search_bad_rank_range_error.t(term: args[:var].inspect, value: args[:val].inspect)
    end
  end
end
