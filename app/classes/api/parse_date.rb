...
class API
  ...
  def parse_date_range(key, args = {})
    ...
    str = get_param(key)
    return args[:default] unless str
    parse_date_range_all_patterns(str)
  rescue ArgumentError
  ...
  def parse_date_range_all_patterns(str)
    parse_date_range_yyyymmdd_x2(str) ||
      parse_date_range_yyyymm_x2(str) ||
      parse_date_range_yyyy_x2(str) ||
      parse_date_range_mmdd_x2(str) ||
      parse_date_range_mm_x2(str) ||
      parse_date_range_yyyymmdd(str) ||
      parse_date_range_yyyymm(str) ||
      parse_date_range_yyyy(str) ||
      parse_date_range_mmdd(str) ||
      parse_date_range_mm(str) ||
      raise(ArgumentError)
  end
  # rubocop:enable Metrics/CyclomaticComplexity
  # rubocop:enable Metrics/PerceivedComplexity

  def parse_date_range_yyyymmdd_x2(str)
  ...
  def parse_date_range_yyyymm_x2(str)
  ...
  def parse_date_range_yyyy_x2(str)
  ...
  def parse_date_range_mmdd_x2(str)
  ...
  def parse_date_range_mm_x2(str)
  ...
  def parse_date_range_yyyymmdd(str)
  ...
  def parse_date_range_yyyymm(str)
