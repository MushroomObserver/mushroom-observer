...
class InternalLink
  ...
  # become the current query.
    ...
    def restored_query
      ...
      restored_query_params = @current_query.params.deep_find(subquery_param)
      return false if restored_query_params.blank?

      Query.lookup(@model, **restored_query_params)
    end
