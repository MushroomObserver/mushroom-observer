...
// Build MyAutocompleter on top of Ajax.Autocompleter.
var MyAutocompleter = Class.create();
Object.extend(MyAutocompleter.prototype, base = Ajax.Autocompleter.prototype);
...
// Build NameAutocompleter on top of MyAutocompleter.
var NameAutocompleter = Class.create();
Object.extend(NameAutocompleter.prototype, base = MyAutocompleter.prototype);
Object.extend(NameAutocompleter.prototype, {

  old_initialize: base.initialize,
  ...
  old_onKeyPress: base.onKeyPress,
  ...
  old_getUpdatedChoices: base.getUpdatedChoices,
